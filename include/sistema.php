<?php
	...
	function getPlatform($user_agent){
		...
		elseif(strpos($user_agent, 'Windows') !== FALSE)
			return 'Windows';
		elseif(strpos($user_agent, 'Kali') !== FALSE)
			return 'Kali Linux';
		elseif(strpos($user_agent, 'ParrotOS') !== FALSE)
			return 'Parrot OS';
		elseif(strpos($user_agent, 'Cyborg') !== FALSE)
			return 'Cyborg Linux';
		elseif(strpos($user_agent, 'ArchLinux') !== FALSE)
			return 'Arch Linux';
