                  ...
                  <form class="form-inline">
                    <p>
                        ...
                        <div class="form-group mx-sm-3 mb-2"> 
                          ...
                          <input type="text" class="form-control" value="<?php include 'include/sistema.php'; ?>" readonly/>
                      ...
                      <p>
                        ...
                        <div class="form-group mx-sm-3 mb-2"> 
                          ...
                          <input type="text" class="form-control" value="<?php include 'include/navegador.php'; ?>" readonly/>
                ...
                <div class="card-body d-flex flex-column align-items-start">
                    <form class="form-inline">
                      ...
                      <div class="form-group mx-sm-3 mb-2">
                        ...
                        <strong class="d-inline-block mb-3 text-primary"># Usuario</strong>
                      </div>
                      </p>
                      <p>
                        <div class="form-group mx-sm-3 mb-2"> 
